...
if command -v pacman >/dev/null 2>&1; then
    ...
    sudo pacman -S --needed --noconfirm niri waybar mako notification-daemon fuzzel fastfetch swaylock swayidle swww kitty helix thunar htop calcurse networkmanager gammastep rust libpipewire pkgconf clang gnu-free-fonts noto-fonts noto-fonts-emoji
